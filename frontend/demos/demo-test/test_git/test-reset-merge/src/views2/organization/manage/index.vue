 ...
 * @LastEditTime: 2021-07-21 16:21:43
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \组织\src\views\organization\manage\index.vue
-->
<template>
  <d2-container :class="{ 'page-compact': crud.pageOptions.compact }">
    <template slot="header">
      <span class="page-title">单位管理员</span>
    ...
    >
      ...
      <template
        ...
        slot-scope="scope"
      >
        <el-image :src="scope.row.memberHeaderUrl">
          <img
            slot="error"
            class="img"
