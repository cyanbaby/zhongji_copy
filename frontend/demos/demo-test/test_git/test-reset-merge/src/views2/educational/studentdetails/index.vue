...
<d2-container>
        ...
        <div class="detail-container-info">
          <div class="detail-container-info-words">
            ...
            <span class="detail-container-info-words-item">状态：
              <el-tag size="mini" v-if="studentInfo.isRemove==1" effect="plain" type="danger">已移除</el-tag>
              <el-tag size="mini" v-if="studentInfo.isRemove==2" effect="plain">在读</el-tag>
            </span>
            ...
            <span class="detail-container-info-words-item"><span class="numControl" :title="studentInfo.companyName">职务：<span class="data">{{studentInfo.jobTitle}}</span></span></span>
        ...
        <el-tab-pane label="直播" name="live">
          <template>
            ...
            >
              ...
              >
              <template slot-scope="scope">
                <span>{{formateTime(scope.row.learnHour)}}</span>
              </template>
              </el-table-column>
              <el-table-column
                prop="stayHour"
              ...
              >
              <template slot-scope="scope">
                <span>{{formateTime(scope.row.stayHour)}}</span>
              </template>
              </el-table-column>
              <el-table-column
                prop="firstInTime"
              ...
              >
                <template slot-scope="scope">
                  <span>{{scope.row.isFinishStudy?'已完成':'未完成'}}</span>
                </template>
              </el-table-column>
            </el-table>
          </template>
    ...
    <el-row>
      ...
      <template>
          <el-table
            ...
            >
            <template slot-scope="scope">
              <el-tag type="success" v-if="scope.row.isPass=='合格'" effect="plain">合格</el-tag>
              <el-tag type="danger" v-if="scope.row.isPass=='不合格'" effect="plain">不合格</el-tag>
            </template>
            </el-table-column>
            <el-table-column
              prop="testScore"
    ...
    <el-row>
      ...
      <div class="certificate">
        <span class="certRegion" style="width:40%">
        <span>证书名称：</span>
        ...
        <span>状态：</span>
        <span class="signCss" v-if="certDetailResultList&&certDetailResultList.length!=0">{{certDetailResultList[0].status}}</span>
        </span>
        <span class="certRegion" style="width:20%">
        <span>申领时间：</span>
