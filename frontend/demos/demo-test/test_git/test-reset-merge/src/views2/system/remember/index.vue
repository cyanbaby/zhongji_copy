 ...
 * @LastEditTime: 2021-07-09 14:59:26
 * @LastEditors: Please set LastEditors
 * @Description: 注册页
 * @FilePath: \组织\src\views\system\remember\index.vue
-->
<template>
    ...
    <div class="animate__animated animate__bounceInDown" flex="dir:left main:center cross:center">
      ...
      <div class="register-box_inner">
        <div style="width: 520px">
          <h1 class="system-title" v-if="changePaw">
            修改密码
          </h1>
          <h1 class="system-title" v-else>
            忘记密码
          </h1>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      timer: null,
      count: 0,
      changePaw: this.$route.query.changePaw
    }
  },
  methods: {
    handleSubmit () {
