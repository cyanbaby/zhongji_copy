<template>
  <d2-container>
    <div class="setting-container">
      ...
      <div class="content">
        <div class="content-title">
          {{ form.name }}
          <el-button class="live-url"
                     type="text"
                     @click="liveLink">直播链接</el-button>
        </div>
      ...
      <div class="edit-live-btn">
        <el-button v-if="$route.query.releaseStatus == 0"
                   type="primary"
                   plain
                   @click="editLive">编辑直播</el-button>
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="基础信息"
          ...
          <el-form ref="form"
                   ...
                   label-width="100px"
                   style="width: 70%">
            <el-form-item label="直播间图标"
                          prop="liveScene">
              <el-image class="classImg"
                        :src="form.channelLogoImage"
                        @click="uploadImg">
                <span slot="error"
                      class="live-uploader"
                      @click="uploadImg">
                  <img :src="form.channelLogoImage"
                       alt="" />
                </span>
              </el-image>
            ...
            <!-- <el-form-item label="暖场内容"
                          prop="liveScenes">
              <div>
                <el-switch v-model="form.isWarmup"
                           active-color="#409eff"
              ...
              <div>
                ...
                <el-radio v-model="form.warmupType"
                          label="1">图片</el-radio>
                <el-radio v-model="form.warmupType"
                          label="2">视频</el-radio>
              </div>
              <div>
                <el-upload v-if="form.warmupType == 1"
                ...
                <el-dialog :visible.sync="form.dialogVisible">
                  <img width="100%"
                       :src="form.warmupImageUrl" />
                </el-dialog>
              </div>
            </el-form-item> -->
            <el-form-item label="介绍"
                          prop="liveScene">
              <vue-rich-text-editor v-model="form.remarkUrl"
                                    :height="60"
                                    :toolbars="toobars" />
            </el-form-item>
            <el-form-item>
              <el-button type="primary"
                         @click="onSubmitBase">保存</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
          ...
          <div style="width: 60%">
            <div>
              ...
              <el-table :data="teacherData"
                        border
                        style="width: 100%">
                <el-table-column prop="roleHeadImg"
                                 label="讲师信息"
                                 width="150">
                  <template slot-scope="scope">
                    <div style="display: flex; align-items: center">
                      <img :src="scope.row.roleHeadImg"
                           alt=""
                ...
                <el-table-column fixed="right"
                  ...
                  <template slot-scope="scope">
                    <el-button type="text"
                               size="small"
                               @click="doSet(scope.row, '讲师')">设置</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
            <div>
              ...
              <el-button type="primary"
                         ...
                         size="small"
                         @click="doSet(0, '助教', true)">添加</el-button>
                ...
                <el-table-column fixed="right"
                  ...
                  <template slot-scope="scope">
                    <div style="width: 100%; height: 100%; display: flex">
                      <el-button type="text"
                                 size="small"
                                 @click="doSet(scope.row, '设置', true)">设置</el-button>
                      <el-button type="text"
                                 size="small"
            ...
            <div>
              ...
              <el-button type="primary"
                         style="margin-bottom: 10px"
                         size="small"
                         @click="doSet(0, '嘉宾')">添加</el-button>
              <el-table :data="guestData"
                        border
                        style="width: 100%">
                <el-table-column prop="date"
                                 label="嘉宾信息"
                ...
                <el-table-column fixed="right"
                  ...
                  <template slot-scope="scope">
                    <el-button type="text"
                               size="small"
                               @click="doSet(scope.row, '嘉宾')">设置</el-button>
                    <el-button type="text"
                               size="small"
                               @click="doDel(scope.row)">删除</el-button>
                  </template>
        ...
        <el-tab-pane label="回放设置"
                     name="third">
          <el-form ref="backform"
                   :model="form"
                   label-width="100px"
                   style="width: 60%">
            <el-form-item label="回放开关"
                          prop="liveSwitch">
              <el-switch v-model="liveSwitch"
                         active-color="#409eff"
            ...
            <el-form-item>
              <el-button type="primary"
                         @click="onSubmitBack">保存</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
        <el-tab-pane label="观看限制条件"
                     name="fouth">
          <el-form ref="formRules"
            ...
            <el-button size="small"
                       ...
                       style="margin-bottom: 10px">
              <i class="el-icon-plus"></i> 导入白名单
            </el-button>
            <el-form-item label="选择观看条件"
                          prop="viewCondition"
                          :rules="rules">
              <el-radio-group v-model="viewCondition"
                              @change="change">
        ...
        <el-tab-pane label="观众列表"
          ...
          <div style="width: 70%; position: relative; padding-bottom: 60px">
            <el-button size="small"
                       ...
                       style="margin-bottom: 10px">
              <i class="el-icon-plus"></i> 导入观众
            </el-button>
            <el-button type="text"
                       @click="updataRule">更新课时规则</el-button>
            <el-table :data="audienceForm"
                      border
            ...
            <el-pagination :current-page.sync="queryInfo.pageNum"
    ...
    <el-dialog :close-on-click-modal="false"
      ...
      <el-form ref="addform"
        ...
        <el-form-item label="成员"
                      prop="userId">
          <el-select ref="mamber"
                     v-model="addform.userId"
                     placeholder="请选择成员"
                     style="width: 100%">
            <el-option v-for="(t, i) in memberArr"
                       :key="i"
                       :label="t.memberName"
    ...
    <!-- 导入观众 -->
    <ImportAudience ref="ImportAudience"
