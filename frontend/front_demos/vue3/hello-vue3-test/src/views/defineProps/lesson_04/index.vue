<template>
  <div class="outer">
      ...
      <div style="flex: 12">
        ...
        <dl>
          ...
          <dd>
            ...
            <p style="display: flex;">
              <b>userState:&nbsp;&nbsp;</b>
            <pre style="font-size: 18px; ">{{ JSON.stringify(userState, null, 4) }}</pre>
            </p>
        ...
        <dl>
          ...
          <dd>
            ...
            <br>
            <br>
            <button @click="changeUserStateInfo">btn5 change changeUserStateInfo</button>&nbsp;&nbsp;
            <button @click="addGirlfriend">btn6 add girlfriend</button>&nbsp;&nbsp;
          </dd>
        </dl>
    ...
    <Child :userState="userState" :numRef="numRef" :user="user" :num="num" @changeNumRef="changeNumRef"
      @changeUserState="changeUserState" @changeWorldText="changeWorldText" />
  </div>
</template>  
...
let worldText = ref('world')

function changeWorldText(text) {
...
function changeUserStateInfo() {
  const height = userState.info.Height + 1
  const weight = userState.info.Weight + 1
  userState.info = {
    Height: height,
    Weight: weight
  }
...
function addGirlfriend() {
  if (!userState?.girlfriend) {
    userState.girlfriend = {
      name: '王祖贤',
      age: 18
    }
  } else {
    let n = userState.girlfriend.age
    let name = '王祖贤__' + ++n
    let age = n
    userState.girlfriend = {
      name,
