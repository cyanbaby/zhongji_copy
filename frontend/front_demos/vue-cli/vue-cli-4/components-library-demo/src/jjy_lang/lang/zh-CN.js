  ...
  fm: {
    components: {
      fields: {
        ...
        picshow: '图片展示',
        qiniuimgupload: '七牛图片',
        qiniufileupload: '七牛文件',
        formtitle: '报名表名称',
        filltext: '填空',
        singleselect: '单选',
        multiselect: '多选',
        singleselectselect: '下拉列表',
        diyfileupload: '文件',
        diyimgupload: '图片',
        singleareaselect: '地区选择',
        singleorgselect: '组织选择',
        diytable: '表格'
      },
      basic: {
        title: '基础字段',
    ...
    actions: {
      ...
      wordCountLimit: '限制字数',
      numberLimit: '限制数字范围',
      relationSetting: '设置题目关联'
    },
    config: {
      diy: {
        headerImage: '页眉图片',
        headerTitle: '报名表标题',
        headerDescription: '报名表说明',
      },
      form: {
        title: '表单属性',
        labelPosition: {
